...
export const Menu = () => {
  return (
    <>
    <div className=" w-full bg-cyan-950  h-18 flex flex-col md:flex-row items-center justify-between rounded-xl border-1 border-green-300">
