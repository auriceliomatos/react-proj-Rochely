        ...
        <div className="max-w-8xl mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden sm:flex space-x-2 ml-auto">
              ...
              <a href="/contatos" className="text-gray-100 text-lg px-3 py-2 hover:bg-fuchsia-400 hover:-translate-y-1 hover:scale-110 duration-200 rounded-md flex items-center gap-2">
