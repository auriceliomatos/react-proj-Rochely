            ...
            <div className="w-full min-h-screen flex flex-col items-center justify-center bg-blue-970">
                ...
                <div className="w-full flex-1 flex flex-col items-center">
                    <div className="max-w-6xl w-full ">
                        ...
                        {/* Header */}
                        <div className="w-full flex items-center justify-center text-center h-40 ">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                            ...
                            <div className="bg-blue-970 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                            ...
                            <div className="bg-blue-970 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                                <div className="text-center">
                                    <h2 className="text-2xl font-bold text-white mb-4">
                                        Horário de Atendimento
                                    </h2>
                                    <div className="space-y-3 text-white">
                                        ...
                                        <p className="text-sm font-medium">Das 08:00 às 18:00</p>
                                    </div>
                                </div>
                            </div>

                            {/* Redes Sociais */}
                            <div className="bg-blue-970 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 md:col-span-2 lg:col-span-1">
                                <div className="text-center">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        >
                                            ...
                                            <span className="font-medium text-sm">rochelymsampaio@gmail.com</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
